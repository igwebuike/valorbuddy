...
RULES = {
 ...
 "employment":["job","employment","resume","employer","interview","apprenticeship","federal job"],
 "career":["career","promotion","training","certification","education path"],
 ...
 "documents":["document","record","dd214","upload","ocr","file"],
